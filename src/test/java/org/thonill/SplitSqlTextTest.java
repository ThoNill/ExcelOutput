...
public class SplitSqlTextTest {
	...
	void testSpliter() {
		...
		testExtraction(" \n\nSELECT * FROM kunden;SELECT * FROM rechnung", "SELECT * FROM kunden");

		testExtraction("SELECT * FROM kunden;SELECT * FROM rechnung", "SELECT * FROM kunden");

		testExtraction("SELECT * FROM kunden\n  \n SELECT * FROM rechnung", "SELECT * FROM kunden");
