...
/**
 * ResultSetValue class implements the Value interface to wrap
 * result set values from a database query. This allows treating
 * result set values as Value objects.
 */
