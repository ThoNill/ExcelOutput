...
/**
 * This class represents a description for replacing a field value. It contains
 * the field name, original value, replacement pattern, and replacement value.
 */
		...
		if (fieldValue.contains(",")) {
			if ("=".equals(c)) {
				...
				throw new IllegalArgumentException(
						"ReplaceDescription.getReplace: invalid replace value: " + fieldValue + " because c= " + c);
			}
		} else {
