 ...
 */
/**
 * Helper class for working with Excel formulas.
 * Allows copying a formula to another cell while adjusting
 * relative cell references. Uses POI classes for parsing
 * and rendering formulas.
 */
